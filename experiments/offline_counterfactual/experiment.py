...
from experiments.offline_counterfactual.bootstrap import (
    block_bootstrap,
    build_latency_pools,
    get_pool_with_fallback,
)
from experiments.offline_counterfactual.policies import (
    RequestResult,
...
from rwsim.policies.latency_routers.online_lp import OnlineLatencyRouter


DEFAULT_OUTPUT_ROOT = Path("experiment") / "results"
...
def run_simulation(
    ...
    trial_csv = Path(output_dir) / "per_trial_results.csv"
...
def main():
    ...
    if args.output_dir is None:
        ...
        args.output_dir = str(DEFAULT_OUTPUT_ROOT / f"counterfactual_no_{exclude_lower}")
