...
def make_policy_presets(
    ...
    *,
    ...
    behavior: RouteWise uses ground-truth ``response_tokens``. See
    ``experiments.simulation.common._normalize_predictor_arg`` for accepted
    string forms.
    """
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "constant_mean, constant_p1..p99, fixed:<value>."
        ),
    )
    parser.add_argument(
        "--predictor-quantile",
