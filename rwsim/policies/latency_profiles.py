...
The rolling-window estimator lives in :mod:`rwsim.core.latency_profile` and
the observed-vs-prior fallback logic in :mod:`rwsim.core.beliefs`
(``LatencyBeliefs``); the simulator's oracle prior is supplied by
``_SimProviderView`` in :mod:`rwsim.policies.routewise`. This module keeps the
