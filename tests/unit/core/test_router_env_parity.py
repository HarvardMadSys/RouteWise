...
checkpoint-hedging decisions through :class:`rwsim.core.router.RouteWiseRouter`.
...
from rwsim.core.hedging import DISPATCH_OVERHEAD_MS
from rwsim.core.router import argmax_weight_sampler
