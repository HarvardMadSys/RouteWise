...
from rwsim.world.distributions import LogNormal, ScaledDistribution
...
class TestRollingProfileBackwardsQueries:
    ...
    def test_deep_backwards_query_uses_defensive_scan(self) -> None:
        ...
        # 190s behind the clock, far beyond one window: defensive path.
        assert profile.mean(10.0) == pytest.approx(100.0)
        assert profile.cdf(150.0, 10.0) == pytest.approx(1.0)
