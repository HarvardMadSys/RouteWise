...
POLICY_LABELS = {
    ...
    "random": "Random",
    "ablation_lp_only_alpha0": r"\sysname{} ($\alpha=0$)",
    "ablation_lp_only_alpha25": "RouteWise-0.25",
    "ablation_lp_only_alpha50": r"\sysname{} ($\alpha=0.5$)",
    "ablation_lp_only_alpha75": r"\sysname{} ($\alpha=0.75$)",
    "ablation_lp_only_alpha100": r"\sysname{} ($\alpha=1$)",
    "ablation_lp_hedging_alpha0": r"\sysname{} ($\alpha=0$ + hedge)",
    "ablation_lp_hedging_alpha25": "RouteWise-0.25 + hedge",
    "ablation_lp_hedging_alpha50": r"\sysname{} ($\alpha=0.5$ + hedge)",
    "ablation_lp_hedging_alpha75": r"\sysname{} ($\alpha=0.75$ + hedge)",
    "ablation_lp_hedging_alpha100": r"\sysname{} ($\alpha=1$ + hedge)",
}
