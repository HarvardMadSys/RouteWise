...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        "--skip-usage-heatmap",
        action="store_true",
        help="Deprecated alias for --skip-utilization-plot.",
    )
    ...
    if not (args.skip_utilization_plot or args.skip_usage_heatmap):
...
def _row_payload(raw: dict[str, str], *, label: str) -> dict[str, Any]:
    return {
        ...
        "subscription_utilization": _concurrency_fraction(raw),
