...
: "${SHARED_PROFILE_PROBE_INTERVAL_SEC:=$PERIODIC_PROBE_INTERVAL_SEC}"
: "${SHARED_PROFILE_IDLE_SEC:=$PERIODIC_PROBE_INTERVAL_SEC}"
...
export SHARED_PROFILE_PROBE_INTERVAL_SEC
export SHARED_PROFILE_IDLE_SEC
