...
The algorithm itself lives in :mod:`llm_routewise.core.router`; this module binds it
...
from llm_routewise.sim.policies.base import NoOpObserveMixin, NoOpTickMixin
from llm_routewise.sim.policies.latency_profiles import (
    DEFAULT_PROFILE_WINDOW_SEC,
    LatencyProfileMode,
    RollingLatencyProfile,
)
from llm_routewise.sim.policies.prefix_cache import cache_aware_marginal_cost, cached_input_tokens
...
def effective_cost(
    ...
    *,
    ...
    :meth:`llm_routewise.core.router.RouteWiseRouter._effective_cost` over
