...
# ``output_tokens >= 1`` convention in ``llm_routewise/sim/world/workload.py``.
...
class ScaledDistribution:
    ...
    parametric families and :class:`~llm_routewise.sim.world.empirical.EmpiricalDistribution`,
