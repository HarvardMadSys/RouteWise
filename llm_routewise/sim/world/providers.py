...
from llm_routewise.core.pricing import cache_discounted_token_cost_usd
from llm_routewise.sim.world.distributions import LatencyDistribution, LogNormal
...
class Provider:
    ...
    Distribution fields use :class:`~llm_routewise.sim.world.distributions.LatencyDistribution`
