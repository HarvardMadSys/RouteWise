...
Usage:
    python -m legacy.experiment.scripts.simulate.offline_counterfactual \
...
from legacy.experiment.scripts.simulate.bootstrap import (
    block_bootstrap,
    build_latency_pools,
    get_pool_with_fallback,
)
from legacy.experiment.scripts.simulate.policies import (
    RequestResult,
