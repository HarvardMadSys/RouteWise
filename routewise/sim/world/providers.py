...
from routewise.core.pricing import cache_discounted_token_cost_usd
from routewise.sim.world.distributions import LatencyDistribution, LogNormal
...
class Provider:
    ...
    Distribution fields use :class:`~routewise.sim.world.distributions.LatencyDistribution`
