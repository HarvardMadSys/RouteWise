...
The rolling-window estimator lives in :mod:`routewise.core.latency_profile` and
the observed-vs-prior fallback logic in :mod:`routewise.core.beliefs`
(``LatencyBeliefs``); the simulator's oracle prior is supplied by
``_SimProviderView`` in :mod:`routewise.sim.policies.routewise`. This module keeps the
