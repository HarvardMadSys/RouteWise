...
| Backup choice | Backup should be non-primary and viable | `select_backup()` supports fastest, LP-other, cheapest-viable | Keep as configurable hedger subpolicy | Backup selection is separate from trigger math |
